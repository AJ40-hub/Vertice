...
-- Apply this with a Supabase role that can alter the public schema objects.
-- Storage policies are intentionally kept in a separate file because
-- storage.objects is owned by Supabase-managed roles in some projects.
